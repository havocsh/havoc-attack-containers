                ...
                if instruct_command == 'run_scan':
                    ...
                    for k,v in scan.items():
                        ...
                        if 'udp' in v:
                            ...
                            task_response['target_port'] = port
                        build_output = build_response(task_response, forward_log, user_id, task_name, task_context,
                                                      task_type, interactive, instruct_user, instruct_instance,
                                                      instruct_command, instruct_args, attack_ip, connection_id,
                                                      end_time)
                        if rt.check:
                            post_response_http(rt, build_output)
                        else:
